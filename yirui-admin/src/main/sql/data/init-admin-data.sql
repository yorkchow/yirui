...
(`id`, `username`, `email`, `mobile`, `password`, `salt`, `create_date`, `status`, `admin`)
values
(1, 'admin', 'admin@sishuok.com', '13412345671', 'ec21fa1738f39d5312c6df46002d403d', 'yDd1956wn1', sysdate(), 'normal', 1);
