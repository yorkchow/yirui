package com.yirui.admin.sys.user.utils;

import com.yirui.common.utils.IpUtils;
...
public class UserLogUtils {
    ...
    private static final Logger SYS_USER_LOGGER = LoggerFactory.getLogger("yirui-admin-sys-user");
