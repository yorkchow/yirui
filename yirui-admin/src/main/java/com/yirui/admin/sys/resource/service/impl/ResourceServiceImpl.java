package com.yirui.admin.sys.resource.service.impl;

import com.yirui.admin.sys.auth.service.UserAuthService;
import com.yirui.admin.sys.resource.dao.ResourceDao;
...
public class ResourceServiceImpl implements ResourceService {
    ...
    public String findActualResourceIdentity(Resource resource) {
        ...
        while(parent != null) {
            ...
            parent = resourceDao.findOne(parent.getParentId());
        }
    ...
    private boolean hasPermission(Resource resource, List<String> userPermissions) {
